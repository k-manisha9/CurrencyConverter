...
function App() {
  ...
  return (
    <>
      <div className='w-full h-screen flex flex-wrap justify-center items-center bg-cover bg-no-repeat' style={{backgroundImage:`url('https://wallpapers.com/images/featured/stock-market-pd5zksxr07t7a4xu.jpg')`}}>
